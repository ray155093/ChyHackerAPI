...
namespace ChyHackerAPI.Models.Service.CounTownCodeQery
{
    ...
    public partial class CounTownCodeService
    {
        ...
        public class CounTownCodeQueryBabPeople : CounTownCodeQuery, ICounTownCodeQueryProvide
        {
            private CounTownCodeInput _input;

            public CounTownCodeQueryBabPeople(CounTownCodeInput input, string _conn)
            {
                this._input = input;
